...
def train(env_name,train_steps = 500000,suffix="",all_loss=0,\
    ...
    blayers = [in_dim]+[layer_width]*layer_depth+[b_dim]
    ...
    best_loss = 1000.0
    best_state_dict = {}
    subsuffix = suffix+"KK_KoopmanNonlinearA"+env_name+"layer{}_edim{}_eloss{}_gamma{}_aloss{}".format(layer_depth,encode_dim,e_loss,gamma,all_loss)
